...
for (let w = 0; w < length(wlans); w++) {
    ...
    for (let s = 0; s < length(stations); s++) {
        ...
        if (station.sta_info?.rx_bitrate?.mcs !== null) {
        ...
        if (station.sta_info?.rx_bitrate?.bitrate32) {
        ...
        if (station.sta_info?.tx_bitrate?.mcs !== null) {
        ...
        if (station.sta_info?.tx_bitrate?.bitrate32) {
